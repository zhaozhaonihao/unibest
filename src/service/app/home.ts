...
export async function getFocusPictureList(params: API.findPetsByStatusParams, options?: API.CustomRequestOptions) {
  return request<unknown>('/getFocusPictureList.json', {
    method: 'GET',
    params: {
      ...params,
    },
...
// }: {
//   body: API.Pet;
//   options?: API.CustomRequestOptions;
// }) {
