...
export default {
	...
	methods: {
		...
		setClipInfo() {
			const { width, height, sysinfo, _canvasId } = this;
		...
		confirm() {
			...
			const { canvasHeight, canvasWidth, clipHeight, clipWidth, scale, ctx, imageLeft, imageTop, clipX, clipY, angle, scaleRatio: dpr, image, quality, fileType, type: imageType, _canvasId } = this;
			const draw = () => {
